package com.pt.lib_common.easyhttp.manager;
...
import com.pt.lib_common.easyhttp.Interceptor.EasyCacheInterceptor;
import com.pt.lib_common.easyhttp.Interceptor.EasyHeaderInterceptor;
import com.pt.lib_common.easyhttp.Interceptor.EasyLoggingInterceptor;
import com.pt.lib_common.easyhttp.Interceptor.EasyUserAgentInterceptor;
import com.pt.lib_common.easyhttp.cache.EasyCacheDir;
import com.pt.lib_common.easyhttp.cache.EasyCacheTime;
...
public class EasyHttpClientManager {
    ...
    public String buildUrl(String url, EasyRequestParams params) {
        if (params != null && params.getRequestParams() != null && params.getRequestParams().size() > 0) {
            Log.d("MainAct_ych", "url = " + url + "?" + params.toString());
