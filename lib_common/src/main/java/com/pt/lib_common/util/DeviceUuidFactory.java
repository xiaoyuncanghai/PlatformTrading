...
public class DeviceUuidFactory {
    ...
    private boolean checkPermission(
        ...
        int perm = context.checkCallingOrSelfPermission("android.permission.$permName");
                        ...
                        try {
                            if (deviceId != null) {
                                ...
                                if (checkPermission(
                                   ...
                                   simSerialNumber = ((TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE)).getSimSerialNumber();
                                }
